...
from core.serializers import CourseWithModulesSerializer, AdminCourseSerializer , CourseUpdateSerializer
...
class ClientCourseListView(generics.ListAPIView):
    """
    Admin (client) – see ALL courses in this schema
    """
...
class ClientCoursePublishView(APIView):
    permission_classes = [permissions.IsAuthenticated, IsClient]
...
class ClientCourseArchiveView(APIView):
    permission_classes = [permissions.IsAuthenticated, IsClient]
...
class ClientCourseDeleteView(APIView):
    permission_classes = [permissions.IsAuthenticated, IsClient]
...
class ClientCourseStudentsView(APIView):
    """
    Admin (client) – see students of ANY course in this schema
    """
    permission_classes = [permissions.IsAuthenticated, IsClient]
...
class ClientCategoryDropdownView(generics.ListAPIView):
